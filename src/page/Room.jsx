  ...
  return (
    <>
      {user ? (
        ...
        <div className="login-container"> <button className="login-button" onClick={login}> <div className="google-icon"> <GoogleIcon size={24} /> </div> Login with Google </button> </div>
      )}
    </>
  );
};
...
//           uniqueId: `${data.from}-${Date.now()}-${Math.random().toString(36).substr(2, 9)}`
//         };
//         setMsgs((msgs) => [...msgs, msg]);
//       });
//       if (user)
...
//                     <motion.div
//                       layout
//                       className={`room-grid ${showChat
//                           ? "room-grid-with-chat"
//                           : "room-grid-without-chat"
//                         }`}
//                     >
//                       <motion.div
//                         layout
//                         className={`room-local-video ${pin && "room-pinned-video"}`}
//                       >
//                         <div className="room-pin-button">
//                           <button
//                             className={`room-pin-btn ${pin
//                                 ? "room-pin-active"
//                                 : "room-pin-inactive"
//                               }`}
//                             onClick={() => setPin(!pin)}
...
//                             <img
//                               className="room-user-placeholder-img"
//                               src={user?.photoURL}
//                               alt={user?.displayName}
//                             />
//                           </div>
...
//                       {peers.map((peer) => (
//                         <MeetGridCard
//                           key={peer.peerID} // Use peerID as key
//                           user={peer.user}
//                           peer={peer.peer}
//                         />
//                       ))}
...
//                         <div>
//                           <button
//                             className={`room-control-btn ${micOn
//                                 ? "room-control-active"
...
//                         <div>
//                           <button
//                             className={`room-control-btn ${videoActive
//                                 ? "room-control-active"
//                                 : "room-control-inactive"
//                               }`}
//                             onClick={() => {
...
//                         >
//                           <CallEndIcon size={20} />
//                           <span className="room-end-call-text">
//                             End Call
//                           </span>
//                         </button>
//                       </div>
...
//                         <div>
//                           <button
//                             className={`room-control-btn ${showChat
//                                 ? "room-control-active"
//                                 : "room-control-inactive"
//                               }`}
//                             onClick={() => {
...
//                   >
//                     <div
//                       className="room-chat-content"
//                     >
//                       <div className="room-participants-section">
//                         <div
//                           className="room-participants-header"
//                           onClick={() => setParticpentsOpen(!particpentsOpen)}
//                         >
//                           <div className="room-participants-icon">
//                             <UsersIcon />
//                           </div>
//                           <div className="room-participants-text">Participants</div>
//                           <div
//                             className={`room-participants-dropdown ${particpentsOpen && "room-dropdown-open"}`}
//                           >
//                             <DownIcon />
//                           </div>
//                         </div>
//                         <motion.div
//                           layout
//                           className={`room-participants-list ${particpentsOpen ? "room-participants-visible" : "room-participants-hidden"}`}
//                         >
//                           <AnimatePresence>
//                             <motion.div
//                               layout
//                               className="room-participant-item"
//                               key={`participant-${user.uid}`} // Use uid for key
//                             >
//                               <img
//                                 src={
//                                   user.photoURL ||
...
//                               <motion.div
//                                 layout
//                                 key={`participant-${peer.peerID}`} // Use peerID for key
//                                 className="room-participant-item"
//                               >
//                                 <img
//                                   src={
...
//                             <ChatIcon />
//                           </div>
//                           <div className="room-chat-text">Chat</div>
//                           <div
//                             className="room-chat-dropdown"
//                             onClick={() => setParticpentsOpen(!particpentsOpen)}
//                           >
//                             <DownIcon />
//                           </div>
...
//                           layout
//                           ref={chatScroll}
//                           className="room-messages-container"
//                         >
//                           {msgs.map((msg) => (
//                             <motion.div
//                               layout
//                               className={`room-message ${msg?.user.id === user?.uid
//                                   ? "room-message-sent"
//                                   : "room-message-received"
//                                 }`}
//                               key={msg.uniqueId} // Use the unique ID we created
//                             >
//                               <img
//                                 src={msg?.user.profilePic}
//                                 alt={msg?.user.name}
...
//                               />
//                               <p className="room-message-content">
//                                 {msg?.message}
//                               </p>
//                             </motion.div>
//                           ))}
...
//                           <div className="room-chat-input-field">
//                             <input
//                               type="text"
//                               value={msgText}
//                               onChange={(e) => setMsgText(e.target.value)}
...
//                           </div>
//                           <div>
//                             <button className="room-chat-send-btn">
//                               <SendIcon />
//                             </button>
//                           </div>
//                         </div>
...
//             <div className="room-google-icon"> 
//               <GoogleIcon size={24} /> 
//             </div> 
//             Login with Google 
//           </button> 
